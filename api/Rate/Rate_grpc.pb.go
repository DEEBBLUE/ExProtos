...
const (
	Rate_GetRate_FullMethodName = "/rate.Rate/GetRate"
)
...
type RateClient interface {
	GetRate(ctx context.Context, in *Req.GetRateReq, opts ...grpc.CallOption) (*Req.GetRateRes, error)
}
...
func (c *rateClient) GetRate(ctx context.Context, in *Req.GetRateReq, opts ...grpc.CallOption) (*Req.GetRateRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Req.GetRateRes)
	err := c.cc.Invoke(ctx, Rate_GetRate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RateServer interface {
	GetRate(context.Context, *Req.GetRateReq) (*Req.GetRateRes, error)
	mustEmbedUnimplementedRateServer()
}

// UnimplementedRateServer must be embedded to have
...
func (UnimplementedRateServer) GetRate(context.Context, *Req.GetRateReq) (*Req.GetRateRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRate not implemented")
}
func (UnimplementedRateServer) mustEmbedUnimplementedRateServer() {}
func (UnimplementedRateServer) testEmbeddedByValue()              {}
...
func RegisterRateServer(s grpc.ServiceRegistrar, srv RateServer) {
	// If the following call pancis, it indicates UnimplementedRateServer was
...
func _Rate_GetRate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Rate_GetRate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RateServer).GetRate(ctx, req.(*Req.GetRateReq))
	}
