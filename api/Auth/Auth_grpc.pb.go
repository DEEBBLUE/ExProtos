...
type AuthClient interface {
	Refresh(ctx context.Context, in *RefsreshReq, opts ...grpc.CallOption) (*RefsreshRes, error)
	Access(ctx context.Context, in *AccessReq, opts ...grpc.CallOption) (*AccessRes, error)
}
...
func (c *authClient) Refresh(ctx context.Context, in *RefsreshReq, opts ...grpc.CallOption) (*RefsreshRes, error) {
...
func (c *authClient) Access(ctx context.Context, in *AccessReq, opts ...grpc.CallOption) (*AccessRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AccessRes)
...
type AuthServer interface {
	Refresh(context.Context, *RefsreshReq) (*RefsreshRes, error)
	Access(context.Context, *AccessReq) (*AccessRes, error)
...
func (UnimplementedAuthServer) Refresh(context.Context, *RefsreshReq) (*RefsreshRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Refresh not implemented")
}
func (UnimplementedAuthServer) Access(context.Context, *AccessReq) (*AccessRes, error) {
...
func _Auth_Refresh_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).Refresh(ctx, req.(*RefsreshReq))
	}
