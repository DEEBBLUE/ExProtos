...
const (
	Stock_GetAllOrders_FullMethodName = "/stock.Stock/GetAllOrders"
)
...
type StockClient interface {
	GetAllOrders(ctx context.Context, in *Req.GetAllOrdersReq, opts ...grpc.CallOption) (*Req.GetAllOrdersRes, error)
}
...
func (c *stockClient) GetAllOrders(ctx context.Context, in *Req.GetAllOrdersReq, opts ...grpc.CallOption) (*Req.GetAllOrdersRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Req.GetAllOrdersRes)
	err := c.cc.Invoke(ctx, Stock_GetAllOrders_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StockServer interface {
	GetAllOrders(context.Context, *Req.GetAllOrdersReq) (*Req.GetAllOrdersRes, error)
...
func (UnimplementedStockServer) GetAllOrders(context.Context, *Req.GetAllOrdersReq) (*Req.GetAllOrdersRes, error) {
...
func _Stock_GetAllOrders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Req.GetAllOrdersReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StockServer).GetAllOrders(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Stock_GetAllOrders_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StockServer).GetAllOrders(ctx, req.(*Req.GetAllOrdersReq))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Stock_GetAllOrders_Handler,
		},
	},
