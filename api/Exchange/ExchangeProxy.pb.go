...
var File_ExchangeProxy_proto protoreflect.FileDescriptor
...
var file_ExchangeProxy_proto_goTypes = []any{
...
var file_ExchangeProxy_proto_depIdxs = []int32{
...
func init() { file_ExchangeProxy_proto_init() }
func file_ExchangeProxy_proto_init() {
	if File_ExchangeProxy_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ExchangeProxy_proto_rawDesc), len(file_ExchangeProxy_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_ExchangeProxy_proto_goTypes,
		DependencyIndexes: file_ExchangeProxy_proto_depIdxs,
	}.Build()
	File_ExchangeProxy_proto = out.File
	file_ExchangeProxy_proto_goTypes = nil
	file_ExchangeProxy_proto_depIdxs = nil
}
