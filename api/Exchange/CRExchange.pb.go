...
var File_CRExchange_proto protoreflect.FileDescriptor
...
var file_CRExchange_proto_goTypes = []any{
...
var file_CRExchange_proto_depIdxs = []int32{
	0, // 0: exchange.CRExchange.CreateCRExchange:input_type -> req.CreateExchangeReq
	1, // 1: exchange.CRExchange.TakeCRExhangeList:input_type -> req.EmptyReq
	...
	4, // 4: exchange.CRExchange.CreateCRExchange:output_type -> req.DefaultRes
	5, // 5: exchange.CRExchange.TakeCRExhangeList:output_type -> req.RepeatListExRes
...
func init() { file_CRExchange_proto_init() }
func file_CRExchange_proto_init() {
	if File_CRExchange_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_CRExchange_proto_rawDesc), len(file_CRExchange_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_CRExchange_proto_goTypes,
		DependencyIndexes: file_CRExchange_proto_depIdxs,
	}.Build()
	File_CRExchange_proto = out.File
	file_CRExchange_proto_goTypes = nil
	file_CRExchange_proto_depIdxs = nil
}
